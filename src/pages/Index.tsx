...
const Index = () => {
  ...
  return (
    <div className="min-h-screen celestial-bg">
      ...
      <div className="container mx-auto px-6 pt-4 pb-8 relative flex flex-col items-center justify-center min-h-[calc(100vh-64px)]">
        <div className="text-center max-w-4xl mx-auto w-full">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <h1 className="text-5xl md:text-6xl font-bold heavenly-text mx-auto">Conexão com Deus</h1>
          </div>
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">Conecte-se com o Divino através de uma experiência única de fé, oração e estudo bíblico personalizado</p>
